...
def _task_environment_middleware(get_response):
    def middleware(request):
        ...
        try:
            ...
            _TASK_ENV.task_execution_count = request.META.get(
                _TASK_EXECUTION_COUNT_HEADER
            )
...
TaskEnvironmentMiddleware = _task_environment_middleware
