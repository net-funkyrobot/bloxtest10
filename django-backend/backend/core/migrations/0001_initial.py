# Generated by Django 3.2.14 on 2022-09-01 15:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('google_iap_id', models.CharField(blank=True, default=None, max_length=150, null=True, unique=True, verbose_name='Google IAP user ID')),
                ('google_iap_namespace', models.CharField(blank=True, default='', max_length=64)),
            ...
            managers=[
                ('objects', backend.core.models.auth.UserManager()),
            ],
        ),
    ]
